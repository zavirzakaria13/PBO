    ...
    <div class="row no-gutters mt-5">
      <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
        <ul class="nav flex-column ml-3 mb-5">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="pendaftaran-ujian.php"><b>Pendaftaran Ujian</b>  </a><hr class="bg-secondary">
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="#">Jadwal Ujian</a><hr class="bg-secondary">
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="Mengunggah Nilai.php"><b>Mengunggah Nilai</b></a><hr class="bg-secondary">
          </li>
          </div>
      <div class="col-md-10 p-5 pt-2">
        <h3><i class=" fas fa-user-graduate mr-2"></i><b>MENGUNGGAH NILAI</b></h3><hr>
