...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nim && $nama && $alamat && $email && $kelas) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update mahasiswa set nim = '$nim',nama='$nama',alamat = '$alamat',email='$email',kelas = '$kelas' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into mahasiswa(nim,nama,alamat,email,kelas) values ('$nim','$nama','$alamat','$email','$kelas')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
