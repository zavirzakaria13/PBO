...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2022 at 08:18 AM
...
INSERT INTO `lembar_kerja` (`id_lembar_kerja`, `tanggal`, `file`, `id_kelompok`) VALUES
...
--
ALTER TABLE `lembar_kerja`
  ADD CONSTRAINT `lembar_kerja_ibfk_1` FOREIGN KEY (`id_kelompok`) REFERENCES `anggota_kelompok` (`id_kelompok`);
